...
public class ChronologicalSortTest {
    ...
    public void testChronologicalSorter() {
        ...
        Recipe r0 = new Recipe ("r0", null, null, null);
        Recipe r1 = new Recipe ("r1", null, null, null);
        Recipe r2 = new Recipe ("r2", null, null, null);
        Recipe r3 = new Recipe ("r3", null, null, null);
        Recipe r4 = new Recipe ("r4", null, null, null);
