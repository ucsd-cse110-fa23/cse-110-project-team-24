...
Given that the user logs in and stays at the Recipe List view, there are two recipes called “Tofu with soy sauce” created at 11/18  and “American Burger” created at 11/19
When the user clicks on the button “Sort List,”
Then a new dropdown pops up, asking the user to choose which methods should be used: “Alphabetically,” “Chronologically from oldest to newest,” or “Chronologically from newest to oldest.”
...
public class US2SortListStoryTest {
    ...
    public void scenario1Test() {
        ...
        Recipe r0 = new Recipe("American Burger", null, null, null);
        Recipe r1 = new Recipe("Tofu with soy sauce", null, null, null);
        Recipe r2 = new Recipe("Fries", null, null, null);
        recipeList.add(r0);
        recipeList.add(r1);
        recipeList.add(r2);
